...
<html>
    ...
    <body>
        ...
        <div id="show-phase" class="content scaffold-show" role="main">
            ...
            <f:display bean="phase" />
            </ol>
            <g:form resource="${phase}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${phase}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
